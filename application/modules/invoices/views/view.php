...
<div id="headerbar">
    <h1 class="headerbar-title" style="font-size: 18px;">
        <?php
        echo trans('invoice') . ' ';
        echo($invoice->invoice_number ? 'No' . $invoice->invoice_number : $invoice->invoice_id);
        ?>
        ...
        <div class="invoice">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <h4>
						<?php _trans('name'); ?>:<a href="<?php echo site_url('clients/view/' . $invoice->client_id); ?>">
