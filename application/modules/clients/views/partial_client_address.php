...
<span class="client-address-street-line">
    <strong><?php _trans('address'); ?>:</strong>&nbsp;<?php echo($client->client_address_1 ? htmlsc($client->client_address_1) . '<br>' : ''); ?>
</span>
...
<br>
<span>
    <strong><?php _trans('vat_id_short'); ?>:</strong>&nbsp;</span><?php echo($client->client_vat_id ? htmlsc($client->client_vat_id) : ''); ?>
</span>
